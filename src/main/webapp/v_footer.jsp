<div class="container-fluid p-0">
	<div class="row gx-0 mt-5" style="background-color: rgb(53, 53, 53);">
		<div
			...
			<div class="row gx-0">
				<div class="col-2 ms-4 mb-3 col-lg-3 ms-lg-4">
					<a class="link-icon"
						href="https://www.facebook.com/FernandezCompany" target="_blank">
						<i class="fab fa-facebook-square"></i>
					</a>
				</div>
				<div class="col-2 mb-3 col-lg-3">
					<a class="link-icon" href="https://twitter.com/FernandezMarket"
						target="_blank"> <i class="fab fa-twitter-square"></i>
					</a>
				</div>
				<div class="col-2 mb-3 col-lg-3">
					<a class="link-icon"
						href="https://www.instagram.com/fernandezmarket/?hl=es-la"
						target="_blank"> <i class="fab fa-instagram-square"></i>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="col-11 mt-3 mb-3 ms-3 col-sm-5 ms-sm-5 col-lg-3 ms-lg-0 mx-lg-auto">
			<h1>
				...
				</a> <a class="link-icon" href="tel:81-1292-9310" target="_blank"> <i
			...
			<h1>
				<a class="titulos-footer" href="/sucursales#HUEVOS EL TAL-IVAN"> Huevos EL TAL-IVAN </a> <a
					...
					class="fas fa-map-marked-alt"></i>
				</a> <a class="link-icon" href="tel:81-1292-9300" target="_blank"> <i
					class="fas fa-phone-square"></i>
				</a>
			</h1>
			<p class="descripcion-footer">
		...
		<div class="col-11 mt-3 mb-3 ms-3 col-sm-5 ms-sm-5 col-lg-3 ms-lg-0 mx-lg-auto">
			<h1>
				<a class="titulos-footer" href="/sucursales#BODEGA 201"> Bodega 201 </a> <a
					...
					class="fas fa-map-marked-alt"></i>
				</a> <a class="link-icon" href="tel:81-1292-9308" target="_blank"> <i
					class="fas fa-phone-square"></i>
				</a>
			</h1>
			<p class="descripcion-footer">
			...
			<h1>
				<a class="titulos-footer" href="/sucursales#BODEGA 203"> Bodega 203 </a> <a
					...
					class="fas fa-map-marked-alt"></i>
				</a> <a class="link-icon" href="tel:81-1159-3931" target="_blank"> <i
					class="fas fa-phone-square"></i>
				</a>
			</h1>
			<p class="descripcion-footer">
